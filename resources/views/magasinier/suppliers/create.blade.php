...
@section('page_title', 'Nouveau fournisseur')
...
@section('content')
    <div class="card" style="max-width:860px; padding:18px; margin: 0 auto;">
        <div style="display:flex; align-items:center; gap:10px; margin-bottom:18px;">
            ...
            <div>
                <h2 style="font-size:18px; margin:0; font-weight:800; color:var(--primary);">Ajouter un fournisseur</h2>
                <p style="font-size:12px; color:var(--muted); margin:0;">Enregistrez les coordonnées du nouveau fournisseur</p>
            </div>
        </div>

        <form method="POST" action="{{ route('magasinier.suppliers.store') }}">
            @csrf
            ...
            <div style="margin-top:12px;">
                ...
                <textarea id="notes" name="notes" rows="3"
                    style="width:100%; padding:10px; border:1px solid var(--border); border-radius:8px;" placeholder="Informations complémentaires, jours de livraison habituels..."></textarea>
            </div>

            <div style="margin-top:12px; display:flex; align-items:center; gap:8px;">
                <input type="checkbox" id="is_active" name="is_active" value="1" checked style="width:18px; height:18px; accent-color:var(--primary);">
