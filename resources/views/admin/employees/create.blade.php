...
@section('content')
    ...
    <div class="create-wrap">
        ...
        <div class="create-header">
            ...
            <div>
                <h2 class="create-header-title">Nouveau compte employé</h2>
                <p class="create-header-sub">Renseignez les informations ci-dessous pour créer le compte</p>
            </div>
        </div>
        ...
        <form id="employee-form" method="POST" action="{{ route('admin.employees.store') }}" autocomplete="off">
            @csrf
                    ...
                    <div class="form-grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <select id="position" name="position" onchange="updateDepartment(this.value)">
                                    <option value="">— Sélectionner —</option>
                                    <option value="magasinier" {{ old('position') == 'magasinier' ? 'selected' : '' }}>Magasinier</option>
                                    <option value="caissier" {{ old('position') == 'caissier' ? 'selected' : '' }}>Caissier</option>
                                    <option value="livreur" {{ old('position') == 'livreur' ? 'selected' : '' }}>Livreur</option>
                                </select>
                            </div>
                            @error('position')
                                <p class="error-msg">{{ $message }}</p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" id="hire_date" name="hire_date" value="{{ old('hire_date') }}" 
            ...
            <div id="step-2" class="form-step" style="display: none;">
                <div class="form-section">
                    ...
                    <div class="form-grid-2">
                        ...
                        <div class="form-group" style="grid-column: 1 / -1; background: #e8f4fd; padding: 12px; border-radius: 8px; border: 1px dashed #004d99; margin-bottom: 12px; display: flex; align-items: center; gap: 10px;">
                            <i class="fa-solid fa-circle-info" style="color: #004d99; font-size: 16px;"></i>
                            <div style="font-size: 13px; color: #004d99; font-weight: 500; text-align: left;">
                                <strong>Génération automatique du Code ID :</strong> Un code d'identification unique (ex: <code>EMP-0001</code>) sera automatiquement généré lors de la création de l'employé. Ce code servira désormais d'identifiant de connexion à la place de l'e-mail.
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="password" id="password" name="password" placeholder="Min. 8 caractères">
                            </div>
                            @error('password')
                                <p class="error-msg">{{ $message }}</p>
                            @enderror
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-yellow">
                        <i class="fa-solid fa-user-plus"></i> Créer l'employé
                    </button>
                </div>
            </div>
